...
HIGH_RESOLUTION_NET.STAGE2.NUM_BRANCHES = 1
HIGH_RESOLUTION_NET.STAGE2.NUM_BLOCKS = [1, 1]
HIGH_RESOLUTION_NET.STAGE2.NUM_CHANNELS = [16, 32]
...
HIGH_RESOLUTION_NET.STAGE3.NUM_BRANCHES = 1
HIGH_RESOLUTION_NET.STAGE3.NUM_BLOCKS = [1, 1]
HIGH_RESOLUTION_NET.STAGE3.NUM_CHANNELS = [16, 32]
...
HIGH_RESOLUTION_NET.STAGE4.NUM_BRANCHES = 1
HIGH_RESOLUTION_NET.STAGE4.NUM_BLOCKS = [1, 1]
HIGH_RESOLUTION_NET.STAGE4.NUM_CHANNELS = [16, 32, 64]
...
def update_config(cfg, args):
    ...
    cfg.merge_from_file('models/cfg.yaml')
